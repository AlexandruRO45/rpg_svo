...
public:
  ...
  ATANCamera(double width, double height, double fx, double fy, double dx, double dy, double s, double scale = 1.0);
  ...
  virtual double scale() const override { return scale_; }
};
