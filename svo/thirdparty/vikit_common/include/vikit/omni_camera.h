...
public:
  ...
  virtual double fx() const override { return 0.0; }
  virtual double fy() const override { return 0.0; }
  virtual double cx() const override { return 0.0; }
  virtual double cy() const override { return 0.0; }
