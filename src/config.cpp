...
Config::Config() :
    ...
    n_pyr_levels(3),
    use_imu(false),
    imu_gyro_noise(1.6968e-4),
    imu_acc_noise(2.0e-3),
    imu_gyro_walk(1.9393E-5),
    imu_acc_walk(3.0e-3),
    core_n_kfs(3),
...
{}
  ...
  Config::Config(
    ...
    use_imu(use_imu_),
    imu_gyro_noise(imu_gyro_noise_),
    imu_acc_noise(imu_acc_noise_),
    imu_gyro_walk(imu_gyro_walk_),
    imu_acc_walk(imu_acc_walk_),
